...
class PagSeguroClass extends Controller
{
	private $email         = "diretoria01@lacs.com.br";
	private $token_sandbox = "3444035864CC434E9BC1807B0A0D94F5";
	private $token_oficial = "C0304B88300E49DE80C13BFE1FEDBEDC";
	private $url_retorno   = "http://www.lacs.web7006.uni5.net/pagseguro/notificacao";
	...
	*/
	...
	public static function executeNotification(Request $request){
		// $url = $this->url_notificacao.$POST['notificationCode'].$this->email_token;
		$url = $this->url_notificacao.$request->notificationCode.$this->email_token;

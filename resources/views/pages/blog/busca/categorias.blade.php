...
@section('content')
    ...
    <div class="container mt-5 mb-4" style="margin-top: 6pc !important;" id="categoria1">
    ...
    ">
            ...
            <div class="row d-flex justify-content-center align-items-center mb-4">
                        ...
                        <div class="row">
                            ...
                            @foreach ($categoria_posts->posts as $post)
                                
                            <div class="card first-card col-4">
                                    <div class="card-wrapper">
                                        <div class="card-img">
                                            ...
                                            <div class="img-text mbr-text mbr-fonts-style align-center mbr-white display-4" style="background-color:{{$categoria_posts->cor}}!important;height: 2vh;"></div></a>
                                        </div>
                                        <div class="card-box">

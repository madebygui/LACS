...
const lista = document.querySelectorAll('#content1-1q li');
const div_mae = document.querySelector(".mbr-text.col-12.col-md-8.col-lg-10.mbr-fonts-style.display-7.text-justify");

const showElements = () => {

    lista.forEach((li,index, array) => {
...
const hideElements = () => { 
	...
	if(lista.length > 25){
		...
		seeMoreButton.onclick = showElements;
		seeMoreButton.classList.add('btn', 'btn-sm', 'btn-secondary-outline' , 'display-4');
		seeMoreButton.innerText = 'Ver Mais';
		teste = seeMoreButton;
		div_mae.append(seeMoreButton);
